...
[Comment the issue to tell us](https://github.com/davidlcarrascal/go-admin/issues/71).
...
More framework examples: [https://github.com/davidlcarrascal/go-admin/tree/master/examples](https://github.com/davidlcarrascal/go-admin/tree/master/examples)
